...
_WIZCHIP  WIZCHIP =
      ...
      .CSE._select          = wizchip_cs_select,
      .CSE._deselect        = wizchip_cs_deselect,
...
void reg_wizchip_cs_cbfunc(void(*cs_sel)(void), void(*cs_desel)(void))
{
   if(!cs_sel || !cs_desel)
   {
      WIZCHIP.CSE._select   = wizchip_cs_select;
      WIZCHIP.CSE._deselect = wizchip_cs_deselect;
   }
   else
   {
      WIZCHIP.CSE._select   = cs_sel;
      WIZCHIP.CSE._deselect = cs_desel;
   }
}
